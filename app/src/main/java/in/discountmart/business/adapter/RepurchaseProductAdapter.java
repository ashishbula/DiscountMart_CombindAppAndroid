...
import in.discountmart.business.fragment.RepurchaseProductFragment;
...
public class RepurchaseProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // public static ArrayList<ProductQuantity> prodQuantityList;
    RepurchaseProductFragment productFragment;
   ...
   /* public static class MyFooter extends RecyclerView.ViewHolder{
    ...
    public RepurchaseProductAdapter(Context context, ArrayList<RepurchaseProductResponse.ProductList> productList, RepurchaseProductFragment fragment) {
    ...
    public void setData(Context context, ArrayList<RepurchaseProductResponse.ProductList> productList, RepurchaseProductFragment fragment) {
        this.mContext = context;
        this.productFragment = fragment;
        this.productArrayList = productList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder != null) {
            ...
            if (holder instanceof MyViewHolder) {
                ...
                myViewHolder.txtProdtPV.setText("PV : "+productArrayList.get(position).getPv());
                myViewHolder.txtProdtDP.setText("DP : "+productArrayList.get(position).getDp());
                myViewHolder.txtProdtPrice.setText(mContext.getResources().getString(R.string.rs_symbol) + " " + productArrayList.get(position).getMrp());
                ...
                myViewHolder.txtIncrement.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        double totRcp=0;
                        double totFVRV=0;
                        double prodtPrice= Double.parseDouble(productArrayList.get(position).getMrp());
                        double prodtRcp= Double.parseDouble(productArrayList.get(position).getDp());
                        ...
                        if(!productArrayList.get(position).isSelected()){
                            ...
                            addProductModel.setMrp(Double.parseDouble(productArrayList.get(position).getMrp()));
            ...
            if(addProductList.size() == 0){
                ...
                for (int i=0;i<addProductList.size();i++){
                    ...
                    //int prodQty=addProductList.get(i).getProdusQuantity();
                     ...
                     price=addProductList.get(i).getTotalMrp();

                }
                productFragment.txtQuantity.setText("Qty :- "+ String.valueOf(qty));
                productFragment.txtPrice.setText(mContext.getResources().getString(R.string.rs_symbol)+" "+ String.valueOf(price));
                ...
                for (int i = 0; i < addProductList.size(); i++) {
                    ...
                    price = price + addProductList.get(i).getTotalMrp();
            ...
            if(addProductList!= null && addProductList.size() > 0) {
                ...
                if(addProductList.size() > 0){
                    for (int k=0;k<addProductList.size();k++){
                        ...
                        price=price+addProductList.get(k).getTotalMrp();
                    }
                    productFragment.txtQuantity.setText("Qty :- "+ String.valueOf(qty));
                    productFragment.txtPrice.setText(mContext.getResources().getString(R.string.rs_symbol)+" "+ String.valueOf(price));
                    int size=addProductList.size();
