...
import in.discountmart.business.activity.RepurchaseOrderProduct;
...
public class RepurchaseOrderProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    RepurchaseOrderProduct productFragment;
    ...
    public void setData(Context context, ArrayList<RepurchaseProductResponse.ProductList> productList, RepurchaseOrderProduct fragment) {
        this.mContext = context;
        this.productFragment = fragment;
        this.productArrayList = productList;
