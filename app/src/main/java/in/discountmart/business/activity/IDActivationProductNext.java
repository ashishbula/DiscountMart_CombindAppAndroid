 ...
 */
public class IDActivationProductNext extends AppCompatActivity {
    ...
    public IDActivationProductNext() {
          ...
          /*  bundle.putString("idno", strMemId);
            ...
            btnSendRequest.setOnClickListener(view -> {
                if (edRemark.getText().toString().equals("")) {
                    Toast.makeText(IDActivationProductNext.this, "Please enter remark.", Toast.LENGTH_LONG).show();
                    edRemark.setFocusable(true);
                } else if (edTPaswd.getText().toString().equals("")) {
                    Toast.makeText(IDActivationProductNext.this, "Please enter Transaction Password.", Toast.LENGTH_LONG).show();
                    edTPaswd.setFocusable(true);
                } else
                    iDActivationAPICall();
            });
            btnCancel.setOnClickListener(view -> {
                Intent activationIntent = new Intent(IDActivationProductNext.this, BusinessDashboardActivity.class);
    ...
    private void iDActivationAPICall() {
        ...
        memberNameResponseCall.enqueue(new Callback<IDActivationResponse>() {
                ...
                try {
                    ...
                    if (Response != null) {
                        if (Response.getResponse().equals("OK")) {
                            AlertDialogUtils.showMaterialDialogWithOneButton_2(IDActivationProductNext.this, new AlertDialogButtonListener() {
                                @Override
                            ...
                            new BusinessDashboardActivity().blankValueFromSharedPreference(IDActivationProductNext.this);
                        } else if (Response.getResponse().contains("FAILED")) {
                            String toast = Response.getResponse() + ":" + Response.getMsg();
                            Toast.makeText(IDActivationProductNext.this, toast, Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        String msg = "Something went wrong.";
                        Toast.makeText(IDActivationProductNext.this, msg, Toast.LENGTH_SHORT).show();
                        new BusinessDashboardActivity().blankValueFromSharedPreference(IDActivationProductNext.this);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            public void onFailure(Call<IDActivationResponse> call, Throwable t) {
                if (pDialog.isShowing())
                    pDialog.dismiss();
                Toast.makeText(IDActivationProductNext.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
