                    ...
                    if (sponsorId && walletBal) {
                        ...
                        String msg= "Do you continue for Id Activation ?" ;
                            if (!ConnectivityUtils.isNetworkEnabled(IDActivationActivity.this)) {
                                ...
                                in.discountmart.utility.AlertDialogUtils.showDialogWithOneButton(IDActivationActivity.this, new in.discountmart.listener.AlertDialogButtonListener() {
                                    @Override
                ...
                try {
                    ...
                    if(Response != null){
                        if (Response.getResponse().equals("OK")) {
                            ...
                            AlertDialogUtils.showDialogWithOneButton(IDActivationActivity.this, new AlertDialogButtonListener() {
                                @Override
                                public void onButtontapped(String btnText) {
                                    if (btnText.equals("OK")) {
                            ...
                            AlertDialogUtils.showDialogWithOneButton(IDActivationActivity.this, new in.discountmart.listener.AlertDialogButtonListener() {
                                @Override
                                public void onButtontapped(String btnText) {
