...
import in.discountmart.business.adapter.RepurchaseOrderProductAdapter;
 ...
 */
public class RepurchaseOrderProduct extends AppCompatActivity {
    View view;
    Context context;
    TextView txtHeader;
    RecyclerView recyclerView;
    RepurchaseOrderProductAdapter adapter;
...
public  TextView txtTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_repurchase_product);
            ...
            try {
                ...
                adapter = new RepurchaseOrderProductAdapter(context, productArrayList, RepurchaseOrderProduct.this);
                ...
                txtOrderNow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            ArrayList<RepurchaseProductResponse.ProductList> stList = ((RepurchaseOrderProductAdapter) adapter)
                                    .getOrderReceiveList();

                            tempSelectProductList = new ArrayList<AddProductModel>();
                            tempSelectProductList = RepurchaseOrderProductAdapter.addProductList;
                            ...
                            if (tempSelectList.size() > 0 && selectOrder && chekQty) {
                                ...
                                Intent activationIntent = new Intent(RepurchaseOrderProduct.this, RepurchaseOrderProductNext.class);
                        ...
                        if (Response != null) {
                            if (Response.getResponse().equals("OK")) {
                                ...
                                if (productArrayList != null && productArrayList.size() > 0) {
                                    ...
                                    adapter.setData(context, productArrayList, RepurchaseOrderProduct.this);

                                } else {
                                    //dailyIncentiveArrayList = new ArrayList<DirectIncomeReponse.DirectIncome>(Arrays.asList(dailyIncentive));
                                    productArrayList.clear();
                                    adapter.setData(RepurchaseOrderProduct.this, productArrayList, RepurchaseOrderProduct.this);
                                ...
                                Toast.makeText(RepurchaseOrderProduct.this, toast, Toast.LENGTH_SHORT).show();
