...
public interface MyTeamService {
   ...
   /* //for  Upliner Tree Api  (Upliner Tree Fragment)
    ...
    Call<CheckValidIDResponse> fetchCheckIdForActivation_new(@Body BaseRequest request, @Header("apikey") String apikey);

    @POST("/ProcessAPIWithK")
    Call<IDActivationResponse> fetchIdForActivation_new(@Body IDActivationRequest_new request, @Header("apikey") String apikey);
