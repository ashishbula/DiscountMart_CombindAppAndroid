...
package in.discountmart.shared_pref_business;
...
public class SharedPrefrence {
    ...
    public static void setDOJ(Context context, String strAddress) {
        Editor edit = getSharedPrefrences(context).edit();
        edit.putString(AppConstants.DOJ, strAddress);
        edit.commit();
    }
    public static String getDOJ(Context context) {
        return getSharedPrefrences(context).getString(AppConstants.DOJ, "");
    }
