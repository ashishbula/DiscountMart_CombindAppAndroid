...
public class MobileRechargeActivity extends AppCompatActivity implements LocationListFragment.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            rdgType=(RadioGroup)findViewById(R.id.mobile_recharge_act_rdg_type);
            rdbPrepaid=(RadioButton)findViewById(R.id.mobile_recharge_act_rdb_prepaid);
            rdbPostpaid=(RadioButton)findViewById(R.id.mobile_recharge_act_rdb_postpaid);
            ...
            if(! strType.equals("")){
               if(strType.equals("T")){
                   rdbPostpaid.setChecked(true);
                   rdbPrepaid.setChecked(false);
               }
               else if(strType.equals("M")){
                   rdbPrepaid.setChecked(true);
                   rdbPostpaid.setChecked(false);
               }
            }

            if(rdbPrepaid.isChecked()){
                strType="M";
                txtSelectOperator.setText(getResources().getString(R.string.str_choose_oprator));
                txtSelectCircle.setText(getResources().getString(R.string.str_choose_circle));
           ...
           /* if(!loginResponse.getMobileNo().contentEquals("") && loginResponse.getMobileNo().length() > 10){
                ...
                public void afterTextChanged(Editable s) {
                    ...
                    if(rdbPrepaid.isChecked()){
                        if(!s.toString().contentEquals("") && s.toString().length() == 10){
                            strAccountNo=edTxtMobile.getText().toString();
                            View view = MobileRechargeActivity.this.getCurrentFocus();
                            if (view != null) {
                        ...
                        if(!s.toString().contentEquals("") && s.toString().length() == 10){
                            ...
                            Toast.makeText(MobileRechargeActivity.this,"Please enter complete mobile no.",
            ...
            /*Radio Groupt Type checked change listner */
            rdgType.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    if(checkedId == R.id.mobile_recharge_act_rdb_prepaid) {
                        strType="M";
                        txtOperator.setText("");
                        txtSelectOperator.setText(getResources().getString(R.string.str_choose_oprator));
                        txtSelectCircle.setText(getResources().getString(R.string.str_choose_circle));
                    ...
                    else if(checkedId == R.id.mobile_recharge_act_rdb_postpaid) {
                        strType="T";
                        //txtOperator.setText("");
                        txtSelectOperator.setText(getResources().getString(R.string.str_choose_oprator));
                        txtSelectCircle.setText(getResources().getString(R.string.str_choose_circle));
            ...
            layoutOperator.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(!strType.equals("")){
                        if(!edTxtMobile.getText().toString().contentEquals("") && edTxtMobile.getText().toString().length() == 10){
                            Intent intent1=new Intent(MobileRechargeActivity.this,ServiceProviderActivity.class);
                ...
                public void onClick(View v) {
                    if(!strType.equals("")){
                        if(edTxtMobile.getText().toString().contentEquals("") && edTxtMobile.getText().toString().length() != 10){
                            ...
                            Toast.makeText(MobileRechargeActivity.this,"Please select operator",
                                    Toast.LENGTH_SHORT).show();
                        }
                        else {

                            myBottomSheet.show(getSupportFragmentManager(), myBottomSheet.getTag());
                            Intent intent1=new Intent(MobileRechargeActivity.this, LocationListFragment.class);
                       ...
                       /* if(txtOperator.getText().toString().equals(getResources().getString(R.string.str_choose_oprator))){
                         ...
                         if(edTxtMobile.getText().toString().equals("")){
                            ...
                            edTxtAmount.requestFocus();
                             ...
                             Toast.makeText(MobileRechargeActivity.this,"Please choose circle",Toast.LENGTH_SHORT).show();
                         }
                        else {

                            if(edTxtMobile.getText().toString().length() < 10 || edTxtMobile.getText().toString().length() > 10){
                                Toast.makeText(MobileRechargeActivity.this,"Please check the number ",Toast.LENGTH_SHORT).show();
                                ...
                                if(!ConnectivityUtils.isNetworkEnabled(MobileRechargeActivity.this)){
                                    Snackbar.make(view, getResources().getString(R.string.network_error), Snackbar.LENGTH_LONG)
                                            .setAction("CLOSE", new View.OnClickListener() {
                                                @Override
                                                public void onClick(View view) {
                                ...
                                if(!ConnectivityUtils.isNetworkEnabled(MobileRechargeActivity.this)){
                                    ...
                                    if(!strIsbbps_Post.equals("")){
                                        ...
                                        if(strType.equals("T") && strIsbbps_Post.equals("false")){
                                            ...
                                            if(postAmount < 50 ){
                                                AlertDialogUtils.showDialog(MobileRechargeActivity.this,
        ...
        collapsingToolbarLayout.setTitle("Mobile Recharge");
                            ...
                            if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                                ...
                                if(!Response.getRESP_VALUE().equals("null") || ! Response.getRESP_VALUE().equals("")){
                                    ...
                                    if(balanceResponse != null){
                                        ...
                                        new LoginPreferences_Utility(MobileRechargeActivity.this).getLoggedinUser().setBalance(balanceResponse.getBalance());
                                ...
                                String toast = Response.getRESPONSE() + "\n" + "Please Login Again. ";
                                Toast.makeText(MobileRechargeActivity.this, toast, Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(MobileRechargeActivity.this, LoginActivity.class);
                        ...
                        if(Response != null){
                            ...
                            if(Response.getCircle() != null && Response.getOperator() != null) {
                                if(!Response.getCircle().contentEquals("") && !Response.getOperator().contentEquals("")){
                                    ...
                                    Toast.makeText(MobileRechargeActivity.this,"Data not found",Toast.LENGTH_SHORT).show();
                                }
                            }
                            else {
                                if(Response.getStatus() != null && Response.getMsg() != null) {
                                    if(Response.getStatus().contentEquals("error") && !Response.getMsg().contentEquals("")){
                                        ...
                                        Toast.makeText(MobileRechargeActivity.this,"Something error",Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                                ...
                                if(!Response.getRESP_VALUE().equals("null") || ! Response.getRESP_VALUE().equals("")){
                                    ...
                                    if(rechargeResponse != null ){
                                        if(rechargeResponse.getStatus().equals("SUCCESS")){
                                            ...
                                            Intent intent=new Intent(MobileRechargeActivity.this,RechargeSucccessMsgActivity.class);
                                            Bundle bundle=new Bundle();
...
//                headerRequest.setSponsorFormNo("");
                                    ...
                                    if( checkResponse != null){
                                        ...
                                        if(checkData.getDueamount()!=null && checkData.getDuedate() != null){
                                            if(!checkData.getDueamount().equals("") && checkData.getDueamount().equals(strAmount)){
                                                ...
                                                edTxtAmount.setEnabled(true);
                                                Toast.makeText(MobileRechargeActivity.this,"Get Dues is blank",Toast.LENGTH_SHORT).show();
                                            }
                                        }
    ...
    void showRechargeDialog(){
        try{
           /* StringBuilder sb = new StringBuilder();
            ...
            AlertDialogUtils.showAlertdialogContext(MobileRechargeActivity.this, new AlertDialogButtonListener() {
                @Override
    ...
    public void RechargeRequest(){
        ...
        Intent intent=new Intent(MobileRechargeActivity.this, CheckFinalDetailRechargeActivity.class);
        Bundle bundle=new Bundle();
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(view, R.string.permission_contacts_rationale,
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat
                                    .requestPermissions(MobileRechargeActivity.this, PERMISSIONS_CONTACT,
                                            REQUEST_CONTACTS);
                        }
