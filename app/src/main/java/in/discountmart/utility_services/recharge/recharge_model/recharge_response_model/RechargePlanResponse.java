...
public class RechargePlanResponse extends BaseResponse implements Serializable{
    ArrayList<RechargePlans>lstPlan;
    ArrayList<RechargePlansUnique>lstUniquePlan;

    public ArrayList<RechargePlans> getLstPlan() {
        return lstPlan;
    }

    public void setLstPlan(ArrayList<RechargePlans> lstPlan) {
        this.lstPlan = lstPlan;
    }

    public ArrayList<RechargePlansUnique> getLstUniquePlan() {
        return lstUniquePlan;
    }

    public void setLstUniquePlan(ArrayList<RechargePlansUnique> lstUniquePlan) {
        this.lstUniquePlan = lstUniquePlan;
    }

    public static class RechargePlans implements Serializable{
        String id;//": "3197782",
        String sp_key;//": "BGP",
    ...
    public static class RechargePlansUnique implements Serializable {
        String id;//": "3197782",
        String sp_key;//": "BGP",
        String sp_circle;//": null,
        String recharge_value;//": "10",
