...
public class PrepaidActivity_autoservice_provider extends AppCompatActivity implements LocationListFragment.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //textViewChange = (TextView) findViewById(R.id.mobile_recharge_act_txt_change);
            ...
            //layoutServiceProvider = (LinearLayout) findViewById(R.id.layout_servicepro_circle);
           ...
           /* if(!loginResponse.getMobileNo().contentEquals("") && loginResponse.getMobileNo().length() > 10){
            ...
            edTxtMobile.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    ...
                    if (!s.toString().contentEquals("") && s.toString().length() == 10) {
                        strAccountNo = edTxtMobile.getText().toString();
                        View view = PrepaidActivity_autoservice_provider.this.getCurrentFocus();
                        if (view != null) {
                ...
                public void onClick(View v) {
                    if (!strType.equals("")) {
                        if (!edTxtMobile.getText().toString().contentEquals("") && edTxtMobile.getText().toString().length() == 10) {
                            Intent intent1 = new Intent(PrepaidActivity_autoservice_provider.this, ServiceProviderActivity.class);
                            ...
                            Toast.makeText(PrepaidActivity_autoservice_provider.this, "Please enter complete mobile no.",
                ...
                public void onClick(View v) {
                    if (!strType.equals("")) {
                        if (edTxtMobile.getText().toString().contentEquals("") && edTxtMobile.getText().toString().length() != 10) {
                            ...
                            Toast.makeText(PrepaidActivity_autoservice_provider.this, "Please select operator",
                                    Toast.LENGTH_SHORT).show();
                        } else {

                            myBottomSheet.show(getSupportFragmentManager(), myBottomSheet.getTag());
                            Intent intent1 = new Intent(PrepaidActivity_autoservice_provider.this, LocationListFragment.class);
                    ...
                    if (strType.contentEquals("M")) {
                       /* if(txtOperator.getText().toString().equals(getResources().getString(R.string.str_choose_oprator))){
                        ...
                        if (edTxtMobile.getText().toString().equals("")) {
                            ...
                            Toast.makeText(PrepaidActivity_autoservice_provider.this, "Please choose service operator", Toast.LENGTH_SHORT).show();
                        } else if (txtCircle.getText().equals("")) {
                            Toast.makeText(PrepaidActivity_autoservice_provider.this, "Please choose circle", Toast.LENGTH_SHORT).show();
                        } else {

                            if (edTxtMobile.getText().toString().length() < 10 || edTxtMobile.getText().toString().length() > 10) {
                                Toast.makeText(PrepaidActivity_autoservice_provider.this, "Please check the number ", Toast.LENGTH_SHORT).show();
                                ...
                                if (!ConnectivityUtils.isNetworkEnabled(PrepaidActivity_autoservice_provider.this)) {
                                    Snackbar.make(view, getResources().getString(R.string.network_error), Snackbar.LENGTH_LONG)
                                            .setAction("CLOSE", new View.OnClickListener() {
                                                @Override
                                                public void onClick(View view) {
                                ...
                                if (!ConnectivityUtils.isNetworkEnabled(PrepaidActivity_autoservice_provider.this)) {
                                    ...
                                    if (!strIsbbps_Post.equals("")) {
                                        ...
                                        if (strType.equals("T") && strIsbbps_Post.equals("false")) {
                                            ...
                                            if (postAmount < 50) {
                                                AlertDialogUtils.showDialog(PrepaidActivity_autoservice_provider.this,
            ...
            textViewChange.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    layoutServiceProvider.setVisibility(View.VISIBLE);
                }
            });
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (serviceProviderArrayList != null && serviceProviderArrayList.size() > 0) {
                    for (int i = 0; i < serviceProviderArrayList.size(); i++) {
                        ...
                        layoutServiceProvider.setVisibility(View.GONE);
                            ...
                            if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                                ...
                                if (!Response.getRESP_VALUE().equals("null") || !Response.getRESP_VALUE().equals("")) {
                                    ...
                                    if (balanceResponse != null) {
                                        ...
                                        new LoginPreferences_Utility(PrepaidActivity_autoservice_provider.this).getLoggedinUser().setBalance(balanceResponse.getBalance());
                                ...
                                String toast = Response.getRESPONSE() + "\n" + "Please Login Again. ";
                                Toast.makeText(PrepaidActivity_autoservice_provider.this, toast, Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(PrepaidActivity_autoservice_provider.this, LoginActivity.class);
                        ...
                        if (Response != null) {
                            ...
                            if (Response.getCircle() != null && Response.getOperator() != null) {
                                if (!Response.getCircle().contentEquals("") && !Response.getOperator().contentEquals("")) {
                                    ...
                                    Toast.makeText(PrepaidActivity_autoservice_provider.this, "Data not found", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                if (Response.getStatus() != null && Response.getMsg() != null) {
                                    if (Response.getStatus().contentEquals("error") && !Response.getMsg().contentEquals("")) {
                                        ...
                                        Toast.makeText(PrepaidActivity_autoservice_provider.this, "Something error", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                                ...
                                if (!Response.getRESP_VALUE().equals("null") || !Response.getRESP_VALUE().equals("")) {
                                    ...
                                    if (rechargeResponse != null) {
                                        if (rechargeResponse.getStatus().equals("SUCCESS")) {
                                            ...
                                            Intent intent = new Intent(PrepaidActivity_autoservice_provider.this, RechargeSucccessMsgActivity.class);
                                            Bundle bundle = new Bundle();
...
//                headerRequest.setSponsorFormNo("");
    ...
    public void RechargeRequest() {
        ...
        Intent intent = new Intent(PrepaidActivity_autoservice_provider.this, CheckFinalDetailRechargeActivity.class);
        Bundle bundle = new Bundle();
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(view, R.string.permission_contacts_rationale,
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat
                                    .requestPermissions(PrepaidActivity_autoservice_provider.this, PERMISSIONS_CONTACT,
                                            REQUEST_CONTACTS);
                        }
