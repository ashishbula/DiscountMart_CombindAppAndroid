...
public class PostpaidActivity extends AppCompatActivity implements LocationListFragment.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            viewLine = (View) findViewById(R.id.mobile_recharge_act_line_plan);
            ...
            home= intent.getStringExtra("Home");
                ...
                layoutRechargePlan.setVisibility(View.GONE);


            /*Get Mobile no from shared preference
             * and if number is available in shared preference
             * than set in edit text mobile no*/
           ...
           /* if(!loginResponse.getMobileNo().contentEquals("") && loginResponse.getMobileNo().length() > 10){
                ...
                edTxtMobile.setText("");
                edTxtMobile.setHint(getResources().getString(R.string.str_enter_mobno));
            }*/
            ...
            edTxtMobile.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                       ...
                       /* else {
                            Toast.makeText(PostpaidActivity.this,"Please enter complete mobile no.",
                ...
                public void onClick(View v) {
                    if(!strType.equals("")){
                        if(!edTxtMobile.getText().toString().contentEquals("") && edTxtMobile.getText().toString().length() == 10){
                            Intent intent1=new Intent(PostpaidActivity.this,ServiceProviderActivity.class);
                ...
                public void onClick(View v) {
                    if(!strType.equals("")){
                        if(edTxtMobile.getText().toString().contentEquals("") && edTxtMobile.getText().toString().length() != 10){
                            ...
                            Toast.makeText(PostpaidActivity.this,"Please select operator",
                                    Toast.LENGTH_SHORT).show();
                        }
                        else {

                            myBottomSheet.show(getSupportFragmentManager(), myBottomSheet.getTag());
                            /*Intent intent1=new Intent(PostpaidActivity.this,CircleListFragment.class);
                ...
                public void onClick(View v) {
                    ...
                    if(strType.contentEquals("M")){
                       /* if(txtOperator.getText().toString().equals(getResources().getString(R.string.str_choose_oprator))){
                            Toast.makeText(PostpaidActivity.this,"Please choose service operator",Toast.LENGTH_SHORT).show();
                        }*/
                        if(edTxtMobile.getText().toString().equals("")){
                            ...
                            Toast.makeText(PostpaidActivity.this,"Please choose circle",Toast.LENGTH_SHORT).show();
                        }
                        else {

                            if(edTxtMobile.getText().toString().length() < 10 || edTxtMobile.getText().toString().length() > 10){
                                Toast.makeText(PostpaidActivity.this,"Please check the number ",Toast.LENGTH_SHORT).show();
                            }
                                ...
                                if(!ConnectivityUtils.isNetworkEnabled(PostpaidActivity.this)){
                                    Snackbar.make(view, getResources().getString(R.string.network_error), Snackbar.LENGTH_LONG)
                                            .setAction("CLOSE", new View.OnClickListener() {
                                                @Override
                                                public void onClick(View view) {
                    ...
                    /*Radio Postpaid is checked*/
                       ...
                       /* else if(edTxtConfMobile.getText().toString().equals("")){
                            edTxtConfMobile.setError("Enter Mobile Number");
                            edTxtConfMobile.requestFocus();
                        }*/
                        else if (!edTxtMobile.getText().toString().equals(edTxtMobile.getText().toString())) {
                            Toast.makeText(PostpaidActivity.this,"Enter correct mobile number ",Toast.LENGTH_SHORT).show();
                        }
                                ...
                                if(!ConnectivityUtils.isNetworkEnabled(PostpaidActivity.this)){
                                    ...
                                    if(!strIsbbps_Post.equals("")){
                                        ...
                                        if(strType.equals("T") && strIsbbps_Post.equals("false")){
                                            ...
                                            if(postAmount < 50 ){
                                                AlertDialogUtils.showDialog(PostpaidActivity.this,
        ...
        collapsingToolbarLayout.setTitle("Postpaid Recharge");
                ...
                if (c.moveToFirst()) {
                    ...
                    if (Integer.valueOf(hasNumber) == 1) {
                        ...
                        while (numbers.moveToNext()) {
                            ...
                            //Toast.makeText(PostpaidActivity.this, "Number="+num, Toast.LENGTH_LONG).show();
                        }
                        if(num.startsWith("+"))
                        {
                            if(num.length()==13)
                ...
                if(serviceProviderArrayList != null && serviceProviderArrayList.size() > 0){
                    for (int i=0;i < serviceProviderArrayList.size();i++){
                        ...
                        strIsbbps_Post=serviceProviderArrayList.get(i).getIsBBPS();
                            ...
                            txtOperator.setText("");
                            txtSelectOperator.setText(serviceProviderArrayList.get(i).getCompanyName());
                ...
                if(circleList != null && circleList.size() > 0){
                    for (int i=0;i < circleList.size();i++){
                        ...
                        opratorCircle= circleList.get(i).getLocation();
                            ...
                            txtCircle.setText("");
                            txtSelectCircle.setText(opratorCircle);
                            ...
                            if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                                ...
                                if(!Response.getRESP_VALUE().equals("null") || ! Response.getRESP_VALUE().equals("")){
                                    ...
                                    if(balanceResponse != null){
                                        ...
                                        new LoginPreferences_Utility(PostpaidActivity.this).getLoggedinUser().setBalance(balanceResponse.getBalance());
                                ...
                                String toast = Response.getRESPONSE() + "\n" + "Please Login Again. ";
                                Toast.makeText(PostpaidActivity.this, toast, Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(PostpaidActivity.this, LoginActivity.class);
                        ...
                        if(Response != null){
                            ...
                            if(Response.getCircle() != null && Response.getOperator() != null) {
                                if(!Response.getCircle().contentEquals("") && !Response.getOperator().contentEquals("")){
                                    ...
                                    Toast.makeText(PostpaidActivity.this,"Data not found",Toast.LENGTH_SHORT).show();
                                }
                            }
                            else {
                                if(Response.getStatus() != null && Response.getMsg() != null) {
                                    if(Response.getStatus().contentEquals("error") && !Response.getMsg().contentEquals("")){
                                        ...
                                        Toast.makeText(PostpaidActivity.this,"Something error",Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
        ...
        try {
           ...
           /* if(loginResponse.getMemMode().equals("D"))
            ...
            Call<BaseResponse> fetchRecharge=
                    NetworkClient_Utility_1.getInstance(this).create(RechargeApi.class).fetchRechargeRequest_postpaid(apiRequest,strToken);
                                ...
                                if(!Response.getRESP_VALUE().equals("null") || ! Response.getRESP_VALUE().equals("")){
                                    ...
                                    if(rechargeResponse != null ){
                                        if(rechargeResponse.getStatus().equals("SUCCESS")){
                                            ...
                                            Intent intent=new Intent(PostpaidActivity.this,RechargeSucccessMsgActivity.class);
                                            Bundle bundle=new Bundle();
...
//                headerRequest.setSponsorFormNo("");
                                    ...
                                    if( checkResponse != null){
                                        ...
                                        if(checkData.getDueamount()!=null && checkData.getDuedate() != null){
                                            if(!checkData.getDueamount().equals("") && checkData.getDueamount().equals(strAmount)){
                                                ...
                                                Toast.makeText(PostpaidActivity.this,"Get Dues is blank",Toast.LENGTH_SHORT).show();
                                            }
                                        }

                                        else {
                                            String toast=checkResponse.getStatus()+ "\n Please check mobile no. or operator";
                                            Toast.makeText(PostpaidActivity.this,
    ...
    void showRechargeDialog(){
        try{
           /* StringBuilder sb = new StringBuilder();
            ...
            AlertDialogUtils.showAlertdialogContext(PostpaidActivity.this, new AlertDialogButtonListener() {
                @Override
    ...
    public void RechargeRequest(){
        ...
        Intent intent=new Intent(PostpaidActivity.this, CheckFinalDetailRechargeActivity.class);
        Bundle bundle=new Bundle();
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(view, R.string.permission_contacts_rationale,
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat
                                    .requestPermissions(PostpaidActivity.this, PERMISSIONS_CONTACT,
                                            REQUEST_CONTACTS);
                        }
    ...
    public void onItemSelect(LocationResponse item) {
        try {
            if(item != null){
                    ...
                    txtSelectCircle.setText(item.getLocation());
            }
        }catch (Exception e){
            e.printStackTrace();
        }
