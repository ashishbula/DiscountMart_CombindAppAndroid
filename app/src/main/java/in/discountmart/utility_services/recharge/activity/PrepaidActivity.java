...
import in.discountmart.utility_services.recharge.fragment.CircleListFragment;
...
public class PrepaidActivity extends AppCompatActivity implements CircleListFragment.Listener {
    public static final String TAG = "MainActivity";
    CollapsingToolbarLayout collapsingToolbarLayout;
    Toolbar toolbar;
    public TextView txtOperator;
    AutoCompleteTextView autoTxtViewCircle;
    AutoCompleteTextView autoTxtViewOperator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //autoTxtViewCircle = (AutoCompleteTextView) findViewById(R.id.mobile_recharge_act_txt_select_circle);
           // autoTxtViewOperator = (AutoCompleteTextView) findViewById(R.id.mobile_recharge_act_txt_selected_oprator);
            ...
            txtSelectPlanText = (TextView) findViewById(R.id.mobile_recharge_act_txt_select_plan);
            txtPlanDetail = (TextView) findViewById(R.id.mobile_recharge_act_txt_plan_detail);
            ...
            edTxtConfMobile=(EditText)findViewById(R.id.mobile_recharge_act_edtxt_confirm_mobile);
            ...
            layoutRechargePlan = (LinearLayout) findViewById(R.id.mobile_recharge_act_layout_plan);
            layoutPlanDetail = (LinearLayout) findViewById(R.id.mobile_recharge_act_layout_plan_detail);
            ...
            edTxtMobile.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                   ...
                   /* if (!s.toString().contentEquals("") && s.toString().length() == 10) {
                        ...
                        View view = PrepaidActivity.this.getCurrentFocus();
                        if (view != null) {
                ...
                public void onClick(View v) {
                    if (!strType.equals("")) {
                        if (!edTxtMobile.getText().toString().contentEquals("") && edTxtMobile.getText().toString().length() == 10) {
                            Intent intent1 = new Intent(PrepaidActivity.this, ServiceProviderActivity.class);
                            ...
                            Toast.makeText(PrepaidActivity.this, "Please enter complete mobile no.",
                ...
                public void onClick(View v) {
                    if (!strType.equals("")) {
                        if (edTxtMobile.getText().toString().contentEquals("") && edTxtMobile.getText().toString().length() != 10) {
                            ...
                            Toast.makeText(PrepaidActivity.this, "Please select operator",
                                    Toast.LENGTH_SHORT).show();
                        }
                        else {
                            final BottomSheetDialogFragment myBottomSheet = CircleListFragment.newInstance(strType);

                            myBottomSheet.show(getSupportFragmentManager(), myBottomSheet.getTag());
                            //Intent intent1 = new Intent(PrepaidActivity.this, CircleListFragment.class);
            ...
            /* Layout for Recharge plan
            *  on click choose plan then show
            *  plan activity  */
            layoutRechargePlan.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    else if(strCircle.equals("")){
                        Toast.makeText(PrepaidActivity.this, "Please select circle",
                                Toast.LENGTH_SHORT).show();

                    }
                    else {
                        Intent planIntent=new Intent(PrepaidActivity.this, RechargePlanActivity.class);
                        planIntent.putExtra("Mobile", strType);
                        planIntent.putExtra("IPCode",strIpcode);
                        planIntent.putExtra("Circle", strCircleId);
                        startActivityForResult(planIntent, 3);
            ...
            btnRecharge.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (strType.contentEquals("M")) {
                       ...
                       /* else if (edTxtConfMobile.getText().toString().equals("")) {
                            edTxtConfMobile.setError("Enter Confirm Mobile Number");
                            edTxtConfMobile.requestFocus();
                        }*/
                        else if (!edTxtMobile.getText().toString().equals(edTxtMobile.getText().toString())) {
                            Toast.makeText(PrepaidActivity.this,"Enter correct mobile number ",Toast.LENGTH_SHORT).show();
                        }

                        else if (txtOperator.getText().equals("")) {
                            Toast.makeText(PrepaidActivity.this, "Please choose service operator", Toast.LENGTH_SHORT).show();
                        }
                        else if (txtCircle.getText().equals("")) {
                            Toast.makeText(PrepaidActivity.this, "Please choose circle", Toast.LENGTH_SHORT).show();
                        }
                            ...
                            if (edTxtMobile.getText().toString().length() < 10 || edTxtMobile.getText().toString().length() > 10) {
                                Toast.makeText(PrepaidActivity.this, "Please check the number ", Toast.LENGTH_SHORT).show();

                            }
                           /* else  if(edTxtConfMobile.getText().toString().length() < 10 || edTxtMobile.getText().toString().length() > 10){
                                Toast.makeText(PrepaidActivity.this,"Please check the number ",Toast.LENGTH_SHORT).show();
                            }*/
                            else {
                                ...
                                if (!ConnectivityUtils.isNetworkEnabled(PrepaidActivity.this)) {
                                    Snackbar.make(view, getResources().getString(R.string.network_error), Snackbar.LENGTH_LONG)
                                            .setAction("CLOSE", new View.OnClickListener() {
                                                @Override
                                                public void onClick(View view) {
                                ...
                                if (!ConnectivityUtils.isNetworkEnabled(PrepaidActivity.this)) {
                                    ...
                                    if (!strIsbbps_Post.equals("")) {
                                        ...
                                        if (strType.equals("T") && strIsbbps_Post.equals("false")) {
                                            ...
                                            if (postAmount < 50) {
                                                AlertDialogUtils.showDialog(PrepaidActivity.this,
        ...
        //collapsingToolbarLayout.setTitle("Prepaid Recharge");
        ...
        try {
            if (reqCode == REQUEST_CODE) {
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (serviceProviderArrayList != null && serviceProviderArrayList.size() > 0) {
                        for (int i = 0; i < serviceProviderArrayList.size(); i++) {
                            ...
                            //autoCompleteTextView.setText(getResources().getString(R.string.str_change_operator));
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    circleList = (ArrayList<CircleListResponse>) bundle.getSerializable("CircleList");

                    if (circleList != null && circleList.size() > 0) {
                        for (int i = 0; i < circleList.size(); i++) {
                            //txtOperator.setText(serviceProviderArrayList.get(i).getCompanyName());

                            opratorCircle = circleList.get(i).getCircleName();
                ...
                if (resultCode == Activity.RESULT_OK) {
                    Bundle bundle = data.getExtras();
                    if(bundle != null){
                        String planDetail=bundle.getString("PlanDetail");
                        String planValue=bundle.getString("Value");
                        layoutPlanDetail.setVisibility(View.VISIBLE);
                        txtPlanDetail.setText(planDetail);
                        edTxtAmount.setText(planValue);
                        txtSelectPlanText.setText(getResources().getString(R.string.str_change_plan));
                    }
                    /*planDetailArrayList = new ArrayList<RechargePlanDetail>();
                    planDetailArrayList = (ArrayList<RechargePlanDetail>) bundle.getSerializable("PlanDetail");

                    if (planDetailArrayList != null && planDetailArrayList.size() > 0) {
                        for (int i = 0; i < planDetailArrayList.size(); i++) {
                            //txtOperator.setText(serviceProviderArrayList.get(i).getCompanyName());

                            strPlanDetail = planDetailArrayList.get(i).getRecharge_description();

                            //txtOperator.setText("");
                            txtPlanDetail.setText(strPlanDetail);
                            txtSelectPlanText.setText(getResources().getString(R.string.str_change_plan));
                        }
                    }*/
                }
                            ...
                            if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                                ...
                                if (!Response.getRESP_VALUE().equals("null") || !Response.getRESP_VALUE().equals("")) {
                                    ...
                                    if (balanceResponse != null) {
                                        ...
                                        new LoginPreferences_Utility(PrepaidActivity.this).getLoggedinUser().setBalance(balanceResponse.getBalance());
                                ...
                                String toast = Response.getRESPONSE() + "\n" + "Please Login Again. ";
                                Toast.makeText(PrepaidActivity.this, toast, Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(PrepaidActivity.this, LoginActivity.class);
                        ...
                        if (Response != null) {
                            ...
                            if (Response.getCircle() != null && Response.getOperator() != null) {
                                if (!Response.getCircle().contentEquals("") && !Response.getOperator().contentEquals("")) {
                                    ...
                                    Toast.makeText(PrepaidActivity.this, "Data not found", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                if (Response.getStatus() != null && Response.getMsg() != null) {
                                    if (Response.getStatus().contentEquals("error") && !Response.getMsg().contentEquals("")) {
                                        ...
                                        Toast.makeText(PrepaidActivity.this, "Something error", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                                ...
                                if (!Response.getRESP_VALUE().equals("null") || !Response.getRESP_VALUE().equals("")) {
                                    ...
                                    if (rechargeResponse != null) {
                                        if (rechargeResponse.getStatus().equals("SUCCESS")) {
                                            ...
                                            Intent intent = new Intent(PrepaidActivity.this, RechargeSucccessMsgActivity.class);
                                            Bundle bundle = new Bundle();
...
//                headerRequest.setSponsorFormNo("");
                                ...
                                if (serviceListResponse.length > 0) {
                                    ...
                                    if (serviceProviderArrayList.size() > 0 && circleList.size() > 0) {
                                        ...
                                        for (int j = 0; j < circleList.size(); j++) {
                                            if (opratorCircle.equals(circleList.get(j).getCircleName())) {
                                                strCircle = circleList.get(j).getCircleName();
                                                circle = true;
    ...
    public void RechargeRequest() {
        ...
        request.setOpratorCode(strOpratorCode);
        request.setServiceType(strType);
        request.setLocation(strCircleId);

        String strRequest = new Gson().toJson(request);
        Log.d("Request :-", strRequest);


        Intent intent = new Intent(PrepaidActivity.this, CheckFinalDetailRechargeActivity.class);
        Bundle bundle = new Bundle();
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(view, R.string.permission_contacts_rationale,
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat
                                    .requestPermissions(PrepaidActivity.this, PERMISSIONS_CONTACT,
                                            REQUEST_CONTACTS);
                        }
    ...
    @Override
    public void onItemSelect(CircleListResponse item) {
        try {
            if (item != null) {

                txtCircle.setText(item.getCircleName());
                strCircle = item.getCircleName();
                strCircleId = item.getCode();
                txtSelectCircle.setText(getResources().getString(R.string.str_change_circle));
    ...
    /*@Override
    public void onItemSelect(RechargePlanDetail item) {
        try {
            //planDetailArrayList = new ArrayList<RechargePlanDetail>();
           // planDetailArrayList = (ArrayList<RechargePlanDetail>) bundle.getSerializable("PlanDetail");
            ...
            *//*if (planDetailArrayList != null && planDetailArrayList.size() > 0) {
            ...
            if(item != null){
                layoutPlanDetail.setVisibility(View.VISIBLE);
                txtPlanDetail.setText(item.getRecharge_description());
                edTxtAmount.setText(item.getRecharge_value());
                txtSelectPlanText.setText(getResources().getString(R.string.str_change_plan));
            }
        }catch ( Exception e){
            e.printStackTrace();
