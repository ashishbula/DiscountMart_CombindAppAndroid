...
import in.discountmart.utility_services.report.report_adapter.BusReportAdapter;
import in.discountmart.utility_services.report.report_api.ReportApi;
import in.discountmart.utility_services.report.report_model.request.BusReportRequest;
...
public class BusBookReportActivity extends AppCompatActivity implements BusReportAdapter.BusReportListener {
    ...
    private static final String TAG = "BusReportActivity";
    ...
    String msg="";
    /*Model Object*/
    ArrayList<BusBookReportResponse.BusReportDetail> reportArrayList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.utility_activity_bus_report);

        try {
            view=findViewById(android.R.id.content);
            edTxtForm=(EditText)findViewById(R.id.bus_report_act_edtxt_from);
            edTxtTo=(EditText)findViewById(R.id.bus_report_act_edtxt_to);
            //spinnerService=(AppCompatSpinner)findViewById(R.id.billpay_report_act_spinner_services);
            recyclerList=(RecyclerView)findViewById(R.id.bus_report_act_recycler_content);
            layoutNoRecord=(LinearLayout)findViewById(R.id.bus_report_act_layout_norecord);
            layoutRecord=(LinearLayout)findViewById(R.id.bus_report_act_layout_record);
            btnSubmit=(Button)findViewById(R.id.bus_report_act_btn_submit);

            getSupportActionBar().setDisplayShowHomeEnabled(true);
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Bus Book Report");

            adapter = new BusReportAdapter(this,this);

            linearLayoutManager= new LinearLayoutManager(getApplicationContext());
            recyclerList.setLayoutManager(linearLayoutManager);
            recyclerList.setItemAnimator(new DefaultItemAnimator());
            recyclerList.addItemDecoration(new DividerItemDecoration(BusBookReportActivity.this,DividerItemDecoration.VERTICAL_LIST,0));
            ...
            /*Button Submitt on click get ledger report record*/
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        isLastPage = false;
                        isLoading=false;
                        reportArrayList=new ArrayList<BusBookReportResponse.BusReportDetail>();
                        ...
                        if(chekcValidation()){
                            ...
                            Toast.makeText(BusBookReportActivity.this,msg,Toast.LENGTH_SHORT).show();
    ...
    @Override
    public void onItemSelected(BusBookReportResponse.BusReportDetail list) {
        try {
            if(list != null){
                if(list.getStatus().contains("BOOKED")){
                    Intent intent=new Intent(this,BusBookingDetailActivity.class);
                    Bundle bundle=new Bundle();
                    bundle.clear();
                    bundle.putSerializable("BusReport",list);
                    intent.putExtras(bundle);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_from_right,R.anim.slide_to_right);
                }
                else {
                    Toast.makeText(this,"Not Booked this bus status is refund",Toast.LENGTH_SHORT).show();
                }
    ...
    /* Request and Response Ledger Report*/
    public void getBusBookReport(){
        try {
           ...
           /* if(loginResponse.getMemMode().equals("D"))
                ...
                BusReportRequest request=new BusReportRequest();
            ...
            Call<BaseResponse> callReportDetail=
                    NetworkClient_Utility_1.getInstance(this).create(ReportApi.class).fetchBusReport(apiRequest,strToken);
                        ...
                        if(Response != null){
                            if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                                ...
                                if(Response.getRESP_VALUE().equals("") || Response.getRESP_VALUE().isEmpty()){
                                    ...
                                    BusBookReportResponse reportResponse = new Gson().fromJson(Response.getRESP_VALUE(),BusBookReportResponse.class);

                                    reportArrayList=reportResponse.getBusReport();
                                ...
                                Toast.makeText(BusBookReportActivity.this, toast, Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(BusBookReportActivity.this, LoginActivity.class);
    ...
    private void loadFirstPage(ArrayList<BusBookReportResponse.BusReportDetail> list) {
        Log.d(TAG, "loadFirstPage: ");
        ArrayList<BusBookReportResponse.BusReportDetail> rechargeReports=new ArrayList<BusBookReportResponse.BusReportDetail>();
    ...
    private void loadNextPage(ArrayList<BusBookReportResponse.BusReportDetail> list,String type) {
        ...
        if (currentPage != TOTAL_PAGES)
            ...
            isLastPage = true;
            Toast.makeText(BusBookReportActivity.this,"No more record available",Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean chekcValidation(){
        ...
        else if(edTxtTo.getText().toString().contentEquals("")) {
            msg="Select to date";
