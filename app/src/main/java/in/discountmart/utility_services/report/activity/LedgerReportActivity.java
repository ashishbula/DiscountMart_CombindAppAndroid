...
import in.discountmart.utility_services.report.report_adapter.LedgerReportAdapter;
import in.discountmart.utility_services.report.report_api.ReportApi;
import in.discountmart.utility_services.report.report_model.request.LedgerReportRequest;
...
public class LedgerReportActivity extends AppCompatActivity implements LedgerReportAdapter.LedgerReportListener {
    ...
    private static final String TAG = "LedgerReportActivity";
    ...
    String msg="";
    /*Model Object*/
    ArrayList<LedgerReportResponse.LedgerReport> reportArrayList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            edTxtForm=(EditText)findViewById(R.id.ledger_report_act_edtxt_from);
            edTxtTo=(EditText)findViewById(R.id.ledger_report_act_edtxt_to);
            //spinnerService=(AppCompatSpinner)findViewById(R.id.billpay_report_act_spinner_services);
            recyclerList=(RecyclerView)findViewById(R.id.ledger_report_act_recycler_content);
            layoutNoRecord=(LinearLayout)findViewById(R.id.ledger_report_act_layout_norecord);
            layoutRecord=(LinearLayout)findViewById(R.id.ledger_report_act_layout_record);
            btnSubmit=(Button)findViewById(R.id.ledger_report_act_btn_submit);

            getSupportActionBar().setDisplayShowHomeEnabled(true);
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Ledger Report");

            adapter = new LedgerReportAdapter(this,this);

            linearLayoutManager= new LinearLayoutManager(getApplicationContext());
            recyclerList.setLayoutManager(linearLayoutManager);
            recyclerList.setItemAnimator(new DefaultItemAnimator());
            recyclerList.addItemDecoration(new DividerItemDecoration(LedgerReportActivity.this,DividerItemDecoration.VERTICAL_LIST,0));
            ...
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        isLastPage = false;
                        isLoading=false;
                        reportArrayList=new ArrayList<LedgerReportResponse.LedgerReport>();
                        ...
                        if(chekcValidation()){
                            ...
                            Toast.makeText(LedgerReportActivity.this,msg,Toast.LENGTH_SHORT).show();
                ...
                public void afterTextChanged(Editable s) {
                    ...
                    if(!s.toString().contentEquals("")){
                        if(edTxtTo.getText().toString().contentEquals(""))
                            Toast.makeText(LedgerReportActivity.this,"Please select to date",Toast.LENGTH_SHORT).show();
                        else {
                            TOTAL_PAGES=1;
                            currentPage=TOTAL_PAGES;
                            isLastPage = false;
                ...
                public void afterTextChanged(Editable s) {
                    ...
                    if(!s.toString().contentEquals("")){
                        if(edTxtForm.getText().toString().contentEquals(""))
                            Toast.makeText(LedgerReportActivity.this,"Please select from date",Toast.LENGTH_SHORT).show();
                        else {
                            TOTAL_PAGES=1;
                            currentPage=TOTAL_PAGES;
                            isLastPage = false;
    ...
    @Override
    public void onItemSelected(LedgerReportResponse.LedgerReport list) {

        try {
            if(list != null){
                Intent intent=new Intent(this,LedgerReportDetailActivity.class);
                Bundle bundle=new Bundle();
                bundle.clear();
                bundle.putSerializable("Ledger",list);
        ...
        try {
           ...
           /* if(loginResponse.getMemMode().equals("D"))
            ...
            Call<BaseResponse> callReportDetail=
                    NetworkClient_Utility_1.getInstance(this).create(ReportApi.class).fetchLedgerReport(apiRequest,strToken);
                        ...
                        if(Response != null){
                            if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                                ...
                                if(Response.getRESP_VALUE().equals("") || Response.getRESP_VALUE().isEmpty()){
                                    ...
                                    LedgerReportResponse reportResponse = new Gson().fromJson(Response.getRESP_VALUE(),LedgerReportResponse.class);

                                    reportArrayList=reportResponse.getLedger();
                                ...
                                Toast.makeText(LedgerReportActivity.this, toast, Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(LedgerReportActivity.this, LoginActivity.class);
    ...
    private void loadFirstPage(ArrayList<LedgerReportResponse.LedgerReport> list) {
        Log.d(TAG, "loadFirstPage: ");
        ArrayList<LedgerReportResponse.LedgerReport> rechargeReports=new ArrayList<LedgerReportResponse.LedgerReport>();
    ...
    private void loadNextPage(ArrayList<LedgerReportResponse.LedgerReport> list,String type) {
        ...
        if (currentPage != TOTAL_PAGES)
            ...
            isLastPage = true;
            Toast.makeText(LedgerReportActivity.this,"No more record available",Toast.LENGTH_SHORT).show();
        }
