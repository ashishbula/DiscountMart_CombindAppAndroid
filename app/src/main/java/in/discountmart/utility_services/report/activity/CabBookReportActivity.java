...
import in.discountmart.utility_services.report.report_adapter.CabReportAdapter;
import in.discountmart.utility_services.report.report_api.ReportApi;
import in.discountmart.utility_services.report.report_model.request.CabBookReportRequest;
...
public class CabBookReportActivity extends AppCompatActivity implements CabReportAdapter.CabReportListener {
    ...
    private static final String TAG = "CabReportActivity";

    CabReportAdapter adapter;
    ...
    String msg="";
    /*Model Object*/
    ArrayList<CabReportResponse.CabReport> reportArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.utility_activity_cab_book_report);

        try {
            view=findViewById(android.R.id.content);
            edTxtForm=(EditText)findViewById(R.id.cab_report_act_edtxt_from);
            edTxtTo=(EditText)findViewById(R.id.cab_report_act_edtxt_to);
            //spinnerService=(AppCompatSpinner)findViewById(R.id.billpay_report_act_spinner_services);
            recyclerList=(RecyclerView)findViewById(R.id.cab_report_act_recycler_content);
            layoutNoRecord=(LinearLayout)findViewById(R.id.cab_report_act_layout_norecord);
            layoutRecord=(LinearLayout)findViewById(R.id.cab_report_act_layout_record);
            btnSubmit=(Button)findViewById(R.id.cab_report_act_btn_submit);

            getSupportActionBar().setDisplayShowHomeEnabled(true);
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Cab Book Report");

            adapter = new CabReportAdapter(this,this);

            linearLayoutManager= new LinearLayoutManager(getApplicationContext());
            recyclerList.setLayoutManager(linearLayoutManager);
            recyclerList.setItemAnimator(new DefaultItemAnimator());
            recyclerList.addItemDecoration(new DividerItemDecoration(CabBookReportActivity.this,DividerItemDecoration.VERTICAL_LIST,0));
            ...
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        isLastPage = false;
                        isLoading=false;
                        reportArrayList=new ArrayList<CabReportResponse.CabReport>();
                        ...
                        if(chekcValidation()){
                            ...
                            Toast.makeText(CabBookReportActivity.this,msg,Toast.LENGTH_SHORT).show();
    ...
    @Override
    public void onItemSelected(CabReportResponse.CabReport list) {

        try {

            if(list != null){
                Intent intent=new Intent(CabBookReportActivity.this,CabBookDetailActivity.class);
                Bundle bundle=new Bundle();
                bundle.putSerializable("CabReport",list);
    ...
    public void getCabBookReport(){
        try {
           ...
           /* if(loginResponse.getMemMode().equals("D"))
                ...
                CabBookReportRequest request=new CabBookReportRequest();
            ...
            Call<BaseResponse> callReportDetail=
                    NetworkClient_Utility_1.getInstance(this).create(ReportApi.class).fetchCabBookReport(apiRequest,strToken);
                        ...
                        if(Response != null){
                            if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                                ...
                                if(Response.getRESP_VALUE().equals("") || Response.getRESP_VALUE().isEmpty()){
                                    ...
                                    CabReportResponse reportResponse = new Gson().fromJson(Response.getRESP_VALUE(),CabReportResponse.class);

                                    reportArrayList=reportResponse.getCabBookingReport();
                                ...
                                Toast.makeText(CabBookReportActivity.this, toast, Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(CabBookReportActivity.this, LoginActivity.class);
    ...
    private void loadFirstPage(ArrayList<CabReportResponse.CabReport> list) {
        Log.d(TAG, "loadFirstPage: ");
        ArrayList<CabReportResponse.CabReport> rechargeReports=new ArrayList<CabReportResponse.CabReport>();
    ...
    private void loadNextPage(ArrayList<CabReportResponse.CabReport> list,String type) {
        ...
        if (currentPage != TOTAL_PAGES)
            ...
            isLastPage = true;
            Toast.makeText(CabBookReportActivity.this,"No more record available",Toast.LENGTH_SHORT).show();
        }
