...
import in.discountmart.utility_services.report.report_adapter.FlightReportAdapter;
import in.discountmart.utility_services.report.report_api.ReportApi;
import in.discountmart.utility_services.report.report_model.request.FlightBookReportRequest;
...
public class FlightBookReportActivity extends AppCompatActivity implements FlightReportAdapter.FlightReportListener {
    ...
    private static final String TAG = "FlightReportActivity";

    FlightReportAdapter adapter;
    ...
    String msg="";
    /*Model Object*/
    ArrayList<FlightReportResponse.FlightReport> reportArrayList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_flight_book_report);

        try {
            view=findViewById(android.R.id.content);
            edTxtForm=(EditText)findViewById(R.id.flight_report_act_edtxt_from);
            edTxtTo=(EditText)findViewById(R.id.flight_report_act_edtxt_to);
            //spinnerService=(AppCompatSpinner)findViewById(R.id.billpay_report_act_spinner_services);
            recyclerList=(RecyclerView)findViewById(R.id.flight_report_act_recycler_content);
            layoutNoRecord=(LinearLayout)findViewById(R.id.flight_report_act_layout_norecord);
            layoutRecord=(LinearLayout)findViewById(R.id.flight_report_act_layout_record);
            btnSubmit=(Button)findViewById(R.id.flight_report_act_btn_submit);

            getSupportActionBar().setDisplayShowHomeEnabled(true);
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Flight Book Report");

            adapter = new FlightReportAdapter(this,this);

            linearLayoutManager= new LinearLayoutManager(this);
            recyclerList.setLayoutManager(linearLayoutManager);
            recyclerList.setItemAnimator(new DefaultItemAnimator());
            recyclerList.addItemDecoration(new DividerItemDecoration(FlightBookReportActivity.this,DividerItemDecoration.VERTICAL_LIST,0));
            ...
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        isLastPage = false;
                        isLoading=false;
                        reportArrayList=new ArrayList<FlightReportResponse.FlightReport>();
                        ...
                        if(chekcValidation()){
                            ...
                            Toast.makeText(FlightBookReportActivity.this,msg,Toast.LENGTH_SHORT).show();
    ...
    @Override
    public void onItemSelected(FlightReportResponse.FlightReport list) {
        try {
            if(list != null){
                Intent intent=new Intent(FlightBookReportActivity.this,FlightBookDetailActivity.class);
                Bundle bundle=new Bundle();
                bundle.putSerializable("FlightReport",list);
    ...
    public void getFlightBookReport(){
        try {
           ...
           /* if(loginResponse.getMemMode().equals("D"))
                ...
                FlightBookReportRequest request=new FlightBookReportRequest();
            ...
            Call<BaseResponse> callReportDetail=
                    NetworkClient_Utility_1.getInstance(this).create(ReportApi.class).fetchFlightReport(apiRequest,strToken);
                        ...
                        if(Response != null){
                            if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                                ...
                                if(Response.getRESP_VALUE().equals("") || Response.getRESP_VALUE().isEmpty()){
                                    ...
                                    FlightReportResponse reportResponse = new Gson().fromJson(Response.getRESP_VALUE(),FlightReportResponse.class);

                                    reportArrayList=reportResponse.getFlightReport();
                                ...
                                Toast.makeText(FlightBookReportActivity.this, toast, Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(FlightBookReportActivity.this, LoginActivity.class);
    ...
    private void loadFirstPage(ArrayList<FlightReportResponse.FlightReport> list) {
        Log.d(TAG, "loadFirstPage: ");
        ArrayList<FlightReportResponse.FlightReport> rechargeReports=new ArrayList<FlightReportResponse.FlightReport>();
    ...
    private void loadNextPage(ArrayList<FlightReportResponse.FlightReport> list,String type) {
        ...
        if (currentPage != TOTAL_PAGES)
            ...
            isLastPage = true;
            Toast.makeText(FlightBookReportActivity.this,"No more record available",Toast.LENGTH_SHORT).show();
        }
