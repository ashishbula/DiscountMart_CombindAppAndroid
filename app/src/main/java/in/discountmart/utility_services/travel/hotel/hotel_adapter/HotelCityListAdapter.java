...
public class HotelCityListAdapter extends RecyclerView.Adapter<HotelCityListAdapter.MyViewHolder> implements Filterable {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            name = view.findViewById(R.id.hotel_city_list_txt_name);
    ...
    public HotelCityListAdapter(Context context, List<GetCityListResponse> contactList, CityListAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.utility_hotel_city_list_item, parent, false);
