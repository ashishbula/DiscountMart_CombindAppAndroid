...
public class ReturnFlightSearchListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<ReturnFlightSearch> flightSearchList;
    private List<ReturnFlightSearch> contactListFiltered;
    private ReturnFlightListAdapterListener listener;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            imgFlightLogo=(ImageView)view.findViewById(R.id.return_flight_search_list_item_img_flight_logo);

            txtFlightName = view.findViewById(R.id.return_flight_search_list_item_txt_flight_name);
            txtFlightCode = view.findViewById(R.id.return_flight_search_list_item_txt_flight_code);
            txtDDate = view.findViewById(R.id.return_flight_search_list_item_txt_departure_date);
            txtDDay = view.findViewById(R.id.return_flight_search_list_item_txt_departure_day);
            txtDTime = view.findViewById(R.id.return_flight_search_list_item_txt_departure_time);
            txtFromCityCode = view.findViewById(R.id.return_flight_search_list_item_txt_from_city);
            txtADate = view.findViewById(R.id.return_flight_search_list_item_txt_arrive_date);
            txtADay = view.findViewById(R.id.return_flight_search_list_item_txt_arrive_day);
            txtATime = view.findViewById(R.id.return_flight_search_list_item_txt_arriv_time);
            txtToCity = view.findViewById(R.id.return_flight_search_list_item_txt_to_city);
            txtTotalTime = view.findViewById(R.id.return_flight_search_list_item_txt_total_hour);
            txtStop = view.findViewById(R.id.return_flight_search_list_item_txt_stop);
            txtRefund = view.findViewById(R.id.return_flight_search_list_item_txt_refundable);
            txtPrice = view.findViewById(R.id.return_flight_search_list_item_txt_price);
            txtSeat = view.findViewById(R.id.return_flight_search_list_item_txt_avail_seat);

            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    // send selected contact in callback
                    listener.onReturnFlightSelected(flightSearchList.get(getAdapterPosition()));
    ...
    public ReturnFlightSearchListAdapter(Context context, List<ReturnFlightSearch> flightList, ReturnFlightListAdapterListener listener) {
    ...
    public void setData(Context context, List<ReturnFlightSearch> flightList, ReturnFlightListAdapterListener listener, String strShort){
        this.mContext=context;
        this.listener=listener;
        this.flightSearchList=flightList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM ) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.utility_return_flight_search_item, parent, false);
            return new MyViewHolder(itemView);
        }
    ...
    public interface ReturnFlightListAdapterListener {
        void onReturnFlightSelected(ReturnFlightSearch contact);
    ...
    public void cheapest(){
        //shorting
        Collections.sort(flightSearchList, new Comparator<ReturnFlightSearch>() {
            @Override
