...
public class FlightSearchListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<FlightSearchResponse> flightSearchList;
    private List<FlightSearchResponse> contactListFiltered;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            imgFlightLogo=(ImageView)view.findViewById(R.id.flight_search_list_item_img_flight_logo);

            txtFlightName = view.findViewById(R.id.flight_search_list_item_txt_flight_name);
            txtFlightCode = view.findViewById(R.id.flight_search_list_item_txt_flight_code);
            txtDDate = view.findViewById(R.id.flight_search_list_item_txt_departure_date);
            txtDDay = view.findViewById(R.id.flight_search_list_item_txt_departure_day);
            txtDTime = view.findViewById(R.id.flight_search_list_item_txt_departure_time);
            txtFromCityCode = view.findViewById(R.id.flight_search_list_item_txt_from_city);
            txtADate = view.findViewById(R.id.flight_search_list_item_txt_arrive_date);
            txtADay = view.findViewById(R.id.flight_search_list_item_txt_arrive_day);
            txtATime = view.findViewById(R.id.flight_search_list_item_txt_arriv_time);
            txtToCity = view.findViewById(R.id.flight_search_list_item_txt_to_city);
            txtTotalTime = view.findViewById(R.id.flight_search_list_item_txt_total_hour);
            txtStop = view.findViewById(R.id.flight_search_list_item_txt_stop);
            txtRefund = view.findViewById(R.id.flight_search_list_item_txt_refundable);
            txtPrice = view.findViewById(R.id.flight_search_list_item_txt_price);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    listener.onFlightSelected(flightSearchList.get(getAdapterPosition()));
                }
            });
        }
    }
    ...
    public FlightSearchListAdapter(Context context, List<FlightSearchResponse> flightList, FlightListAdapterListener listener) {
    ...
    public void setData(Context context, List<FlightSearchResponse> flightList,FlightListAdapterListener listener,String strShort){
        this.mContext=context;
        this.listener=listener;
        this.flightSearchList=flightList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder != null) {
            ...
            if(holder instanceof MyViewHolder){
                ...
                myViewHolder.txtDDate.setText(strDepartDate[0]);
                ...
                myViewHolder.txtADate.setText(strArrivalDate[0]);
   ...
   public int getItemCount() {
    ...
    public interface FlightListAdapterListener {
        void onFlightSelected(FlightSearchResponse contact);
    ...
    public void fastest(){
        ...
        Collections.sort(flightSearchList, new Comparator<FlightSearchResponse>() {
            @Override
            public int compare(FlightSearchResponse o1, FlightSearchResponse o2) {//differenceTime
