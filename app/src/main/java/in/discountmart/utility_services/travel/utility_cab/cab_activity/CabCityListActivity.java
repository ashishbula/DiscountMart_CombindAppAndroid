...
import in.discountmart.utility_services.travel.utility_cab.cab_adapter.CabCityListAdapter;
import in.discountmart.utility_services.travel.utility_cab.cab_model.cab_request_mdel.CabCityRequest;
import in.discountmart.utility_services.travel.utility_cab.cab_model.cab_response_model.CabCityListResponse;
...
public class CabCityListActivity extends AppCompatActivity implements CabCityListAdapter.CityListAdapterListener {
    private RecyclerView recyclerView;
    private List<CabCityListResponse> cityLists;
    private CabCityListAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.utility_activity_cab_city_list);

        view = findViewById(android.R.id.content);
        try {
            Toolbar toolbar = findViewById(R.id.cab_city_list_toolbar);
            edtxtSearch = (EditText) findViewById(R.id.cab_city_list_main_content_edtxt_search);
            ...
            recyclerView = findViewById(R.id.cab_city_list_main_content_recycler_view);
            ...
            mAdapter = new CabCityListAdapter(CabCityListActivity.this, cityLists, this);
            ...
            recyclerView.addItemDecoration(new DividerItemDecoration(CabCityListActivity.this, DividerItemDecoration.VERTICAL_LIST, 36));
            recyclerView.setAdapter(mAdapter);

            if (!ConnectivityUtils.isNetworkEnabled(CabCityListActivity.this)) {
                Toast.makeText(CabCityListActivity.this, getResources().getString(R.string.network_error),
    ...
    /* Request and Response  Cab City*/
    public void getCabCityList() {
...
//                headerRequest.setSponsorFormNo("");
            ...
            CabCityRequest getCityList = new CabCityRequest();
            getCityList.setName("");
            getCityList.setID("");
        ...
        Call<BaseResponse> fetchBusFromCityListCall =
                NetworkClient_Utility_1.getInstance(this).create(CabServiceApi.class).fetchCabCityList(apiRequest, strToken);
                        ...
                        if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                            ...
                            if (Response.getRESP_VALUE().equals("") || Response.getRESP_VALUE().isEmpty()) {
                                ...
                                if (cityListResponse.length > 0) {
                                    CabCityListResponse[] cityList = new Gson().fromJson(Response.getRESP_VALUE(), CabCityListResponse[].class);
                                    List<CabCityListResponse> tempList = new ArrayList<CabCityListResponse>(Arrays.asList(cityList));
                                    ...
                                    Toast.makeText(CabCityListActivity.this, toast, Toast.LENGTH_SHORT).show();
                                    //showSnackbar(toast);
                                }
                            }
                            ...
                            Toast.makeText(CabCityListActivity.this, toast, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CabCityListActivity.this, LoginActivity.class);
    ...
    @Override
    public void onContactSelected(CabCityListResponse list) {
        try {
