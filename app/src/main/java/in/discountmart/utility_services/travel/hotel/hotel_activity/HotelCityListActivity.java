...
import in.discountmart.utility_services.travel.hotel.hotel_adapter.HotelCityListAdapter;
import in.discountmart.utility_services.travel.hotel.hotel_model.hotel_request_model.GetCityList;
import in.discountmart.utility_services.travel.hotel.hotel_model.hotel_response_model.GetCityListResponse;
...
public class HotelCityListActivity extends AppCompatActivity implements HotelCityListAdapter.CityListAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.utility_activity_hotel_city_list);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        view=findViewById(android.R.id.content);
        try {
            Toolbar toolbar = findViewById(R.id.hotel_city_list_toolbar);
            edtxtSearch=(EditText)findViewById(R.id.hotel_city_list_content_edtxt_search);
            ...
            recyclerView = findViewById(R.id.hotel_city_list_content_recycler_view);
            ...
            mAdapter = new HotelCityListAdapter(HotelCityListActivity.this, cityLists, this);
            ...
            recyclerView.addItemDecoration(new DividerItemDecoration(HotelCityListActivity.this,DividerItemDecoration.VERTICAL_LIST,36));
...
//                headerRequest.setSponsorFormNo("");
        ...
        Call<BaseResponse> fetchHotelCityListCall=
                NetworkClient_Utility_1.getInstance(HotelCityListActivity.this).create(HotelApi.class).fetchHoteltCityList(apiRequest,strToken);

        fetchHotelCityListCall.enqueue(new Callback<BaseResponse>() {
            @Override
                        ...
                        if (Response.getRESP_CODE().equals("0") && Response.getRESPONSE().equals("SUCCESS")) {
                            ...
                            if(Response.getRESP_VALUE().equals("") || Response.getRESP_VALUE().isEmpty()){
                                ...
                                if(cityListResponse.length > 0){
                                    ...
                                    Toast.makeText(HotelCityListActivity.this, toast, Toast.LENGTH_SHORT).show();
                                    //showSnackbar(toast);
                                }
                            }
                        }
                            ...
                            Toast.makeText(HotelCityListActivity.this, toast, Toast.LENGTH_SHORT).show();
                            Intent intent=new Intent(HotelCityListActivity.this, LoginActivity.class);
    ...
    public void onContactSelected(GetCityListResponse contact) {
        ...
        try {
            ...
            HotelSearchActivity.txtCity.setText(contact.getCityName());
            HotelSearchActivity.txtCityId.setText(contact.getCityCode());
            HotelSearchActivity.strCityCode=contact.getCityCode();
            HotelSharedValues.getInstance().citycode=contact.getCityCode();
            HotelSharedValues.getInstance().countryCode=contact.getCountryCode();
