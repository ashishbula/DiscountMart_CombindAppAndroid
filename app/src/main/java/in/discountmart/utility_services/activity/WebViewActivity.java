            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if ( keyCode == KeyEvent.KEYCODE_BACK) {
                    if (webView.canGoBack()) {
                        ...
                        Log.d("CanGoBack","No");
                        if(type.equals("TicketF")){
                            finish();
                        }
                        else {
                            if(new LoginPreferences_Utility(WebViewActivity.this).getLoggedinUser().getUserName().equals("")){
                                ...
                                Intent intent=new Intent(WebViewActivity.this, MainActivity_utility.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(intent);
       ...
       /* if (!searchView.isIconified()) {
        ...
        if(type.equals("TicketF")){
            ...
            if(new LoginPreferences_Utility(WebViewActivity.this).getLoggedinUser().getUserName().equals("")){
                ...
                Intent i = new Intent(WebViewActivity.this, MainActivity_utility.class);
